            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title">Appraisal result <b><?= $data['nama_user'] ?> <?= $data['nilai_leader'] + $data['nilai_hrd'] ?><?= $data['nilai_leader'] + $data['nilai_hrd'] < 10 ? '( Less and Not Accepted)' : '( Accepted)' ?></b> as an Implementor employee at PT Inovasi Kesehatan Indonesia</h5>
