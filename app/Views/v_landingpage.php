...
<main>
    ...
    <!-- ======= Team Section ======= -->
    <section id="team" class="team section-bg text-center mt-4">
        <div class="container">
            ...
            <!-- <div class="section-title mob">
                <h2 style="font-size: 6vw; font-weight: bolder; color: darkgray;" data-aos="fade-up">CONTACT</h2>
                <h3 style="font-size: 5vw; font-weight: bolder; margin-top: -30px;" data-aos="fade-up" data-aos-duration="1500">CONTACT</h3>
            </div> -->
            <div class="section-title">
                <h2 id="h2" style="font-size: 4vw; font-weight: bolder; color: darkgray;" data-aos="fade-up">CONTACT</h2>
                <h3 id="h3" style="font-size: 3.5vw; font-weight: bolder; margin-top: -55px;" data-aos="fade-up" data-aos-duration="1500">CONTACT</h3>
            </div>
    ...
    <section id="contact" class="contact container">
        <div class="row gy-4">
            ...
            <div class="col-xl-12 " data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <form action="forms/contact.php" method="post" class="php-email-form">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-12 text-center">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.456651449093!2d106.8551086102822!3d-6.203333660741261!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5362d4268f1%3A0x3e1ed000345c62c3!2sKesia%20Indonesia!5e0!3m2!1sen!2sus!4v1686749525004!5m2!1sen!2sus" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" id="frame"></iframe>
